...
Pour obtenir des conseils sur la manière de minimiser les problèmes présentés à la fois dans le magasin physique et dans le processus d’inscription unique, consultez la section [Qualité et hygiène des données](#data-quality-and-hygiene) de ce guide pour en savoir plus et pour connaître les avantages du double opt-in.
...
**Acheter ou louer une**
listeIl y a de nombreux types d&#39;adresses email là-bas. Courrier électronique Principal, e-mails de travail, e-mails scolaires, courriers électroniques secondaires et courriers électroniques inactifs, pour n’en citer que quelques-uns. Les types d’adresses collectées et partagées par le biais de listes achetées ou louées sont rarement des comptes de messagerie Principaux, qui sont les lieux où se produisent la quasi-totalité des activités d’engagement et d’achat.
